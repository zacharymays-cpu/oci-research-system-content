export const V5EvidenceJuryMetadata = {
...
export function V5EvidenceJury() {
  return (
    <>
          ...
          <svg viewBox="0 0 700 500" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', marginTop: '1.5rem', marginBottom: '2rem' }}>
            <defs>
              <style>{`
                ...
                .accent-arrow { stroke: var(--accent); stroke-width: 2; fill: none; marker-end: url(#arrowhead-accent); }
              `}</style>
            ...
            <rect x="30" y="185" width="180" height="80" className="box" rx="4" style={{ stroke: 'var(--accent)', strokeWidth: 2 }} />
            <text x="120" y="220" className="label" textAnchor="middle" fill="var(--text-1)" fontSize="16">Claude Sonnet</text>
            <text x="120" y="245" className="small-label" textAnchor="middle">No shared context</text>

            <rect x="260" y="185" width="180" height="80" className="box" rx="4" style={{ stroke: 'var(--accent)', strokeWidth: 2 }} />
            <text x="350" y="220" className="label" textAnchor="middle" fill="var(--text-1)" fontSize="16">GPT-4o</text>
            <text x="350" y="245" className="small-label" textAnchor="middle">No shared context</text>

            <rect x="490" y="185" width="180" height="80" className="box" rx="4" style={{ stroke: 'var(--accent)', strokeWidth: 2 }} />
            <text x="580" y="220" className="label" textAnchor="middle" fill="var(--text-1)" fontSize="16">Gemini Pro</text>
            ...
            <text x="350" y="370" style={{ fontSize: '11px', fill: 'var(--text-3)', textAnchor: 'middle' }}>Spread Thresholds: 0-5pt strong | 6-10pt accept with notes | 11-20pt review | &gt;20pt revise</text>

            <path d="M 350 385 L 350 415" className="arrow" />

            <rect x="50" y="415" width="600" height="70" className="box" rx="4" style={{ stroke: 'var(--accent)', strokeWidth: 2 }} />
      ...
      <section className="section">
        <div className="container--wide">
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Three-Model Jury</h3>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Evidence Framework</h3>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Consensus Logic</h3>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Human Review Gate</h3>
          <p>Jury proposals require human review before acceptance based on spread thresholds.</p>

          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Scoring Outputs (Generated in Parallel)</h3>
          ...
          <table style={{ width: '100%', marginTop: '1.5rem', borderCollapse: 'collapse' }}>
            <tbody>
              <tr style={{ borderBottom: '1px solid var(--rule)' }}>
                <td style={{ padding: '1rem', fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--gold)', textTransform: 'uppercase' }}>Adoption Date</td>
                <td style={{ padding: '1rem', color: 'var(--text-1)' }}>2026-06-01</td>
              </tr>
              <tr style={{ borderBottom: '1px solid var(--rule)' }}>
                <td style={{ padding: '1rem', fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--gold)', textTransform: 'uppercase' }}>Organizations Scored</td>
                <td style={{ padding: '1rem', color: 'var(--text-1)' }}>565+ (all with jury provenance)</td>
              </tr>
              <tr style={{ borderBottom: '1px solid var(--rule)' }}>
                <td style={{ padding: '1rem', fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--gold)', textTransform: 'uppercase' }}>Status</td>
                <td style={{ padding: '1rem', color: 'var(--text-1)', fontWeight: 'bold' }}>✓ Current Production</td>
              </tr>
            </tbody>
          </table>
      ...
      <section className="section">
        <div className="container--wide">
          <div style={{ display: 'flex', gap: '2rem', justifyContent: 'space-between', alignItems: 'center', marginTop: '2rem' }}>
            <a href="/research-system/v4-anchor-heuristic" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem' }}>
              ← See V4.0's approach
            </a>
