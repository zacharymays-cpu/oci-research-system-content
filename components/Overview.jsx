      ...
      <section className="section">
        <div className="container--wide">
          ...
          <svg viewBox="0 0 900 620" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', marginTop: '1.5rem', marginBottom: '2rem' }}>
            <defs>
              <style>{`
                .arch-box { fill: var(--overlay); stroke: var(--rule); stroke-width: 1.5; }
                .arch-label { font-family: 'Playfair Display', serif; font-size: 16px; fill: var(--text-1); font-weight: 600; }
                .arch-small { font-family: 'DM Mono', monospace; font-size: 11px; fill: var(--gold); text-transform: uppercase; letter-spacing: 0.08em; }
                .arch-arrow { stroke: var(--text-faint); stroke-width: 2; fill: none; marker-end: url(#arrowhead); }
                .arch-track { stroke: color-mix(in srgb, var(--accent) 25%, transparent); stroke-width: 1.5; fill: none; stroke-dasharray: 5,5; }
              `}</style>
            ...
            {/* Human Review Gate */}
            <rect x="20" y="460" width="860" height="70" className="arch-box" rx="4" style={{ stroke: 'var(--accent)', strokeWidth: 2 }} />
            ...
            {/* Output Layer */}
            <rect x="20" y="560" width="860" height="50" className="arch-box" rx="4" style={{ stroke: 'var(--gold)', strokeWidth: 2 }} />
      ...
      <section className="section">
        <div className="container--wide">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginTop: '1.5rem' }}>
            <div>
              <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.1rem', marginBottom: '0.75rem', color: 'var(--text-1)' }}>Rigor Without Single Points of Failure</h3>
              <ul style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', color: 'var(--text-1)', fontSize: '0.95rem' }}>
            ...
            <div>
              <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.1rem', marginBottom: '0.75rem', color: 'var(--text-1)' }}>Transparent & Auditable</h3>
              <ul style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', color: 'var(--text-1)', fontSize: '0.95rem' }}>
          ...
          <div style={{ marginTop: '2rem' }}>
            <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.1rem', marginBottom: '0.75rem', color: 'var(--text-1)' }}>Generalizable Across Domains</h3>
            <ul style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', color: 'var(--text-1)', fontSize: '0.95rem' }}>
      ...
      <section className="section">
        <div className="container--wide">
          ...
          <div style={{ marginTop: '1.5rem' }}>
            <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.2rem', marginBottom: '0.75rem', color: 'var(--text-1)' }}>Current System (V4.0+)</h3>
            <p style={{ color: 'var(--text-2)', marginBottom: '1rem', fontSize: '0.95rem' }}>
              Deep dive into modern methodology versions with full technical details, validation results, and trade-offs.
            </p>
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '2rem' }}>
              <a href="/research-system/v4-anchor-heuristic" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V4.0: Anchor Heuristic</a>
              <a href="/research-system/v5-0-evidence-jury" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V5.0: Evidence Jury</a>
              <a href="/research-system/v5-1-formal-validation" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V5.1: Validation</a>
              <a href="/research-system/v5-2-deepseek-case-study" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V5.2: Case Study</a>
              <a href="/research-system/v6-0-lifton-framework" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V6.0: Lifton</a>
              <a href="/research-system/v6-1-permanence-aware" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V6.1: Permanence</a>
            </div>
          </div>

          <div>
            <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.2rem', marginBottom: '0.75rem', color: 'var(--text-1)' }}>Historical Evolution (V0-V3)</h3>
            <p style={{ color: 'var(--text-2)', marginBottom: '1rem', fontSize: '0.95rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <a href="/research-system/v0-young-reed-framework" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V0: Young & Reed</a>
              <a href="/research-system/v1-dual-metric-concept" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V1: Dual-Metric</a>
              <a href="/research-system/v3-streamlit-era" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V3: Streamlit Era</a>
              <a href="/research-system/evolution-timeline" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>Full Timeline</a>
            </div>
          </div>
        </div>
      </section>
