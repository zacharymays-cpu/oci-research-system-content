export const V52DeepseekCaseStudyMetadata = {
...
export function V52DeepseekCaseStudy() {
  return (
    <>
      <section className="hero">
        <div className="container--narrow">
          <span className="hero__eyebrow"><a href="/research-system">Research System Architecture</a></span>
          <h1 className="hero__title hero__title--compact" style={{ color: 'var(--accent)' }}>V5.2: The Deepseek Experiment</h1>
      ...
      <section className="section">
        <div className="container--wide">
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Hypothesis</h3>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Model Selection Rationale</h3>
          ...
          <table style={{ width: '100%', marginTop: '1.5rem', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ borderBottom: '2px solid var(--rule)' }}>
                <th style={{ padding: '1rem', textAlign: 'left', fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--gold)', textTransform: 'uppercase', fontWeight: 600 }}>Metric</th>
                <th style={{ padding: '1rem', textAlign: 'left', fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--gold)', textTransform: 'uppercase', fontWeight: 600 }}>V5.1 (4 models)</th>
                <th style={{ padding: '1rem', textAlign: 'left', fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--gold)', textTransform: 'uppercase', fontWeight: 600 }}>V5.2 (5 models)</th>
                <th style={{ padding: '1rem', textAlign: 'left', fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--gold)', textTransform: 'uppercase', fontWeight: 600 }}>Impact</th>
              </tr>
            </thead>
            <tbody>
              <tr style={{ borderBottom: '1px solid var(--rule)', background: 'color-mix(in srgb, var(--accent) 4%, transparent)' }}>
                <td style={{ padding: '1rem', fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--text-1)' }}>Avg Jury Spread</td>
                <td style={{ padding: '1rem', color: 'var(--text-1)' }}>6.2 pts</td>
                <td style={{ padding: '1rem', color: 'var(--accent)', fontWeight: 'bold' }}>8.7 pts ↑</td>
                <td style={{ padding: '1rem', color: 'var(--accent)', fontWeight: 'bold' }}>WORSE</td>
              </tr>
              <tr style={{ borderBottom: '1px solid var(--rule)', background: 'color-mix(in srgb, var(--accent) 4%, transparent)' }}>
                <td style={{ padding: '1rem', fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--text-1)' }}>Consensus Strong %</td>
                <td style={{ padding: '1rem', color: 'var(--text-1)' }}>48%</td>
                <td style={{ padding: '1rem', color: 'var(--accent)', fontWeight: 'bold' }}>28% ↓</td>
                <td style={{ padding: '1rem', color: 'var(--accent)', fontWeight: 'bold' }}>WORSE</td>
              </tr>
              <tr style={{ borderBottom: '1px solid var(--rule)' }}>
                <td style={{ padding: '1rem', fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--text-1)' }}>Avg Krippendorff's α</td>
                <td style={{ padding: '1rem', color: 'var(--text-1)' }}>0.74</td>
                <td style={{ padding: '1rem', color: 'var(--accent)', fontWeight: 'bold' }}>0.61 ↓</td>
                <td style={{ padding: '1rem', color: 'var(--accent)', fontWeight: 'bold' }}>Below threshold</td>
              </tr>
            </tbody>
          </table>
      ...
      <section className="section">
        <div className="container--wide">
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Why This Was the Right Call</h3>
      ...
      <section className="section">
        <div className="container--wide">
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginBottom: '1rem', color: 'var(--text-1)' }}>For Model Selection</h3>
          <ul style={{ marginTop: '1rem', paddingLeft: '2rem', color: 'var(--text-1)' }}>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>For Future Methodology Changes</h3>
          <ul style={{ marginTop: '1rem', paddingLeft: '2rem', color: 'var(--text-1)' }}>
      ...
      <section className="section">
        <div className="container--wide">
          <div style={{ display: 'flex', gap: '2rem', justifyContent: 'space-between', alignItems: 'center', marginTop: '2rem' }}>
            <a href="/research-system/v5-1-formal-validation" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem' }}>
