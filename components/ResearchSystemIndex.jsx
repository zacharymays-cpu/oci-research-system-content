export const ResearchSystemIndexMetadata = {
...
export function ResearchSystemIndex() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="section">
        <div className="container--narrow">
          ...
          <svg viewBox="0 0 1000 300" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', marginTop: '2rem' }}>
            <defs>
              <style>{`
                .timeline-box { fill: var(--overlay); stroke: var(--rule); stroke-width: 1; }
                .timeline-title { font-family: 'Playfair Display', serif; font-size: 18px; fill: var(--text-1); font-weight: 600; }
                .timeline-label { font-family: 'DM Mono', monospace; font-size: 12px; fill: var(--gold); text-transform: uppercase; letter-spacing: 0.1em; }
                .timeline-arrow { stroke: var(--text-faint); stroke-width: 2; fill: none; marker-end: url(#arrowhead); }
                .timeline-rejected { fill: color-mix(in srgb, var(--accent) 10%, transparent); stroke: color-mix(in srgb, var(--accent) 30%, transparent); }
              `}</style>
            ...
            <text x="85" y="95" style={{ fontSize: '12px', fill: 'var(--text-3)', textAnchor: 'middle' }}>Single Model</text>
            ...
            <text x="275" y="95" style={{ fontSize: '12px', fill: 'var(--text-3)', textAnchor: 'middle' }}>Current Prod</text>
            ...
            <text x="465" y="95" style={{ fontSize: '12px', fill: 'var(--text-3)', textAnchor: 'middle' }}>Pilot</text>

            {/* Arrow V5.1 → V5.2 (Rejected) */}
            <path d="M 530 70 L 580 70" className="timeline-arrow" stroke="color-mix(in srgb, var(--accent) 30%, transparent)" />

            {/* V5.2 (Rejected) */}
            <rect x="580" y="20" width="140" height="100" className="timeline-box timeline-rejected" rx="4" />
            <text x="655" y="50" className="timeline-title" textAnchor="middle" fill="var(--accent)">V5.2</text>
            <text x="655" y="75" className="timeline-label" textAnchor="middle" fill="var(--accent)">Deepseek</text>
            <text x="655" y="95" style={{ fontSize: '12px', fill: 'var(--accent)', textAnchor: 'middle', fontWeight: 'bold' }}>❌ Rejected</text>
            ...
            <text x="755" y="235" style={{ fontSize: '12px', fill: 'var(--text-3)', textAnchor: 'middle' }}>Prod Ready</text>
            ...
            <text x="930" y="235" style={{ fontSize: '12px', fill: 'var(--text-3)', textAnchor: 'middle' }}>Proposed</text>
          </svg>
      ...
      <section className="section">
        <div className="container--wide">
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.2rem', marginBottom: '1rem', marginTop: '1.5rem', color: 'var(--text-1)' }}>1. Jury Consensus Mechanism</h3>
          ...
          <ul style={{ paddingLeft: '2rem', color: 'var(--text-2)', fontSize: '0.9rem', marginBottom: '1.5rem' }}>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.2rem', marginBottom: '1rem', marginTop: '1.5rem', color: 'var(--text-1)' }}>2. Evidence Framework (8-Tier Hierarchy)</h3>
          <p style={{ color: 'var(--text-2)', marginBottom: '0.75rem' }}>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.2rem', marginBottom: '1rem', marginTop: '1.5rem', color: 'var(--text-1)' }}>3. Human Review Gate (Non-Negotiable Governance)</h3>
          <p style={{ color: 'var(--text-2)', marginBottom: '0.75rem' }}>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.2rem', marginBottom: '1rem', marginTop: '1.5rem', color: 'var(--text-1)' }}>4. Immutable Audit Trail &amp; Provenance Chain</h3>
          <p style={{ color: 'var(--text-2)', marginBottom: '0.75rem' }}>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.2rem', marginBottom: '1rem', marginTop: '1.5rem', color: 'var(--text-1)' }}>5. Logging &amp; Change History</h3>
          <p style={{ color: 'var(--text-2)', marginBottom: '0.75rem' }}>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.2rem', marginBottom: '1rem', marginTop: '1.5rem', color: 'var(--text-1)' }}>6. Formal Validation Metrics</h3>
          <p style={{ color: 'var(--text-2)', marginBottom: '0.75rem' }}>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.2rem', marginBottom: '1rem', marginTop: '1.5rem', color: 'var(--text-1)' }}>7. Why This Architecture Matters</h3>
          <p style={{ color: 'var(--text-2)', marginBottom: '0.75rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', marginTop: '2rem' }}>
            ...
            <a href="/research-system/v4-anchor-heuristic" style={{ textDecoration: 'none' }}>
              <div className="book-card" style={{ position: 'relative', padding: '2rem', border: '1px solid var(--rule)', borderLeft: '3px solid var(--accent)' }}>
                <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.3rem', marginBottom: '0.5rem', color: 'var(--text-1)' }}>V4.0</h3>
                <p style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.75rem', color: 'var(--gold)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '1rem' }}>Anchor Heuristic</p>
                <p style={{ fontSize: '0.95rem', color: 'var(--text-3)', lineHeight: 1.6 }}>Single-model scoring with calibration exemplars. Foundation approach.</p>
              </div>
            </a>
            ...
            <a href="/research-system/v5-0-evidence-jury" style={{ textDecoration: 'none' }}>
              <div className="book-card" style={{ position: 'relative', padding: '2rem', border: '1px solid var(--rule)', borderLeft: '3px solid var(--gold)' }}>
                <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.3rem', marginBottom: '0.5rem', color: 'var(--text-1)' }}>V5.0</h3>
                <p style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.75rem', color: 'var(--gold)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '1rem' }}>Current Production</p>
                <p style={{ fontSize: '0.95rem', color: 'var(--text-3)', lineHeight: 1.6 }}>Three-model jury with evidence-based scoring. Primary system.</p>
              </div>
            </a>
            ...
            <a href="/research-system/v5-1-formal-validation" style={{ textDecoration: 'none' }}>
              <div className="book-card" style={{ position: 'relative', padding: '2rem', border: '1px solid var(--rule)', borderLeft: '3px solid var(--accent)' }}>
                <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.3rem', marginBottom: '0.5rem', color: 'var(--text-1)' }}>V5.1</h3>
                <p style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.75rem', color: 'var(--gold)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '1rem' }}>Formal Validation</p>
                <p style={{ fontSize: '0.95rem', color: 'var(--text-3)', lineHeight: 1.6 }}>Four-model jury with Krippendorff's alpha validation. Pilot phase.</p>
              </div>
            </a>

            {/* V5.2 Case Study Card */}
            <a href="/research-system/v5-2-deepseek-case-study" style={{ textDecoration: 'none' }}>
              <div className="book-card" style={{ position: 'relative', padding: '2rem', border: '1px solid color-mix(in srgb, var(--accent) 25%, transparent)', borderLeft: '3px solid var(--accent)', background: 'color-mix(in srgb, var(--accent) 4%, transparent)' }}>
                <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.3rem', marginBottom: '0.5rem', color: 'var(--text-1)' }}>V5.2</h3>
                <p style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.75rem', color: 'var(--accent)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '1rem', fontWeight: 'bold' }}>Case Study: Rejected</p>
                <p style={{ fontSize: '0.95rem', color: 'var(--text-3)', lineHeight: 1.6 }}>Deepseek experiment and why it failed. Lessons for future improvements.</p>
              </div>
            </a>
            ...
            <a href="/research-system/v6-0-lifton-framework" style={{ textDecoration: 'none' }}>
              <div className="book-card" style={{ position: 'relative', padding: '2rem', border: '1px solid var(--rule)', borderLeft: '3px solid var(--accent)' }}>
                <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.3rem', marginBottom: '0.5rem', color: 'var(--text-1)' }}>V6.0</h3>
                <p style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.75rem', color: 'var(--gold)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '1rem' }}>Lifton Framework</p>
                <p style={{ fontSize: '0.95rem', color: 'var(--text-3)', lineHeight: 1.6 }}>Dual-track system with Lifton's totalism framework. Production-ready.</p>
              </div>
            </a>
      ...
      <section className="section">
        <div className="container--wide">
          <p style={{ textAlign: 'center', marginTop: '2rem' }}>
            <a href="/research-system/evolution-timeline" style={{ color: 'var(--gold)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem' }}>
