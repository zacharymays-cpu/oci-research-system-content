export const V60LiftonFrameworkMetadata = {
...
export function V60LiftonFramework() {
  return (
    <>
      ...
      <section className="section">
        <div className="container--wide">
          ...
          <svg viewBox="0 0 700 400" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', marginTop: '1.5rem', marginBottom: '2rem' }}>
            ...
            <text x="170" y="180" style={{ fontSize: '11px', fill: 'var(--text-3)', textAnchor: 'middle' }}>3-Model Jury</text>
            ...
            <text x="530" y="180" style={{ fontSize: '11px', fill: 'var(--text-3)', textAnchor: 'middle' }}>Parallel Jury</text>
            ...
            <text x="350" y="305" style={{ fontSize: '11px', fill: 'var(--text-3)', textAnchor: 'middle' }}>5-Tier Classification based on preponderance</text>
          </svg>
      ...
      <section className="section">
        <div className="container--wide">
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Young's 10 Criteria (C1-C10)</h3>
          <p>Behavioral indicators of cultic control: deception, unquestioning obedience, exploitation, isolation, etc.</p>

          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Lifton's Totalism (C11)</h3>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Configural Scoring</h3>
          ...
          <div style={{ background: 'color-mix(in srgb, var(--gold) 8%, transparent)', padding: '1.5rem', marginTop: '1.5rem', borderLeft: '3px solid var(--gold)' }}>
            <h4 style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--gold)', textTransform: 'uppercase', margin: '0 0 1rem 0' }}>Lifton Classification Tiers</h4>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', fontSize: '0.9rem', color: 'var(--text-1)' }}>
          ...
          <table style={{ width: '100%', marginTop: '1.5rem', borderCollapse: 'collapse' }}>
            <tbody>
              <tr style={{ borderBottom: '1px solid var(--rule)' }}>
                <td style={{ padding: '1rem', fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--gold)', textTransform: 'uppercase' }}>Approval Date</td>
                <td style={{ padding: '1rem', color: 'var(--text-1)' }}>2026-06-12</td>
              </tr>
              <tr style={{ borderBottom: '1px solid var(--rule)' }}>
                ...
                <td style={{ padding: '1rem', color: 'var(--text-1)' }}>536+ fully scored</td>
              </tr>
              <tr style={{ borderBottom: '1px solid var(--rule)' }}>
                <td style={{ padding: '1rem', fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--gold)', textTransform: 'uppercase' }}>Krippendorff's α</td>
                <td style={{ padding: '1rem', color: 'var(--text-1)' }}>0.81 (threshold met)</td>
              </tr>
              <tr style={{ borderBottom: '1px solid var(--rule)' }}>
                <td style={{ padding: '1rem', fontFamily: 'DM Mono, monospace', fontSize: '0.85rem', color: 'var(--gold)', textTransform: 'uppercase' }}>Status</td>
                <td style={{ padding: '1rem', color: 'var(--text-1)', fontWeight: 'bold' }}>✓ Production-Ready</td>
              </tr>
            </tbody>
          </table>
      ...
      <section className="section">
        <div className="container--wide">
          <div style={{ display: 'flex', gap: '2rem', justifyContent: 'space-between', alignItems: 'center', marginTop: '2rem' }}>
            ...
            <a href="/research-system/v6-1-permanence-aware" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem' }}>
