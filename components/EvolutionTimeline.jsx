export const EvolutionTimelineMetadata = {
    ...
    <>
      ...
      <section className="section">
        <div className="container--wide">
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>V4.0: Single-Model Anchor Heuristic</h3>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>V5.0: Evidence-Based Multi-Model Jury</h3>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>V5.1: Formal Validation Metrics</h3>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>V5.2: The Deepseek Experiment (Rejected)</h3>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>V6.0: Framework Extension (Lifton Totalism)</h3>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>V6.1: Permanence-Aware Refinement</h3>
      ...
      <section className="section">
        <div className="container--wide">
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Core Principles</h3>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Key Decisions</h3>
          <ul style={{ marginTop: '1rem', paddingLeft: '2rem', color: 'var(--text-1)' }}>
      ...
      <section className="section">
        <div className="container--wide">
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Before Testing</h3>
          <ul style={{ marginTop: '1rem', paddingLeft: '2rem', color: 'var(--text-1)' }}>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>If Results Are Negative</h3>
          <ul style={{ marginTop: '1rem', paddingLeft: '2rem', color: 'var(--text-1)' }}>
          ...
          <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.4rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--text-1)' }}>Incremental vs. Revolutionary</h3>
          <ul style={{ marginTop: '1rem', paddingLeft: '2rem', color: 'var(--text-1)' }}>
      ...
      <section className="section">
        <div className="container--wide">
          <div style={{ textAlign: 'center', marginTop: '2rem' }}>
            <p style={{ fontSize: '0.95rem', color: 'var(--text-3)' }}>
              Each methodology is documented separately for deep-dive reference:
            </p>
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', marginTop: '1.5rem', flexWrap: 'wrap' }}>
              <a href="/research-system/v4-anchor-heuristic" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V4.0</a>
              <a href="/research-system/v5-0-evidence-jury" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V5.0</a>
              <a href="/research-system/v5-1-formal-validation" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V5.1</a>
              ...
              <a href="/research-system/v6-0-lifton-framework" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V6.0</a>
              <a href="/research-system/v6-1-permanence-aware" style={{ color: 'var(--text-1)', textDecoration: 'none', borderBottom: '1px solid var(--gold)', paddingBottom: '0.25rem', fontSize: '0.9rem' }}>V6.1</a>
            </div>
          </div>
        </div>
      </section>
